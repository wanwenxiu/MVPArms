package me.wwx.mvparms.demo.app;
...
import me.wwx.mvparms.demo.mvp.model.api.service.UserService;
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                ...
                if (activity.findViewById(R.id.toolbar) != null) {
                    if (activity instanceof AppCompatActivity) {
                        ...
                        ((AppCompatActivity) activity).getSupportActionBar().setTitle(activity.getTitle());
