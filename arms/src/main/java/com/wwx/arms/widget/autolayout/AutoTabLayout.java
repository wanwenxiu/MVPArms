package com.wwx.arms.widget.autolayout;
...
public class AutoTabLayout extends TabLayout
{
    ...
    public AutoTabLayout(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.wwx.arms.R.styleable.TabLayout,
                defStyleAttr, com.wwx.arms.R.style.Widget_Design_TabLayout);
        int tabTextAppearance = a.getResourceId(com.wwx.arms.R.styleable.TabLayout_tabTextAppearance,
                com.wwx.arms.R.style.TextAppearance_Design_Tab);
    ...
    {
        TypedArray a = context.obtainStyledAttributes(attrs, com.wwx.arms.R.styleable.AutoTabLayout);
        mTextSizeBaseWidth = a.getBoolean(com.wwx.arms.R.styleable.AutoTabLayout_auto_textSize_base_width, false);
        a.recycle();
    }
    ...
    private int loadTextSizeFromTextAppearance(int textAppearanceResId)
    {
        TypedArray a = getContext().obtainStyledAttributes(textAppearanceResId,
                com.wwx.arms.R.styleable.TextAppearance);

        try
        {
            if (!DimenUtils.isPxVal(a.peekValue(com.wwx.arms.R.styleable.TextAppearance_android_textSize)))
                return NO_VALID;
            return a.getDimensionPixelSize(com.wwx.arms.R.styleable.TextAppearance_android_textSize, NO_VALID);
        } finally
        {
            a.recycle();
        }
